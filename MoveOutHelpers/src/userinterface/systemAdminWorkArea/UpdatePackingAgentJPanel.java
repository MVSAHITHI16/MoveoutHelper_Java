 ...
 * @author harshila
 */
public class UpdatePackingAgentJPanel extends javax.swing.JPanel {
    ...
    private PackingAgent packingAgent;
    private User userLogged;
    private String imagePath;
    private static final Logger logger = Logger.getLogger(UpdatePackingAgentJPanel.class.getName());

    public UpdatePackingAgentJPanel(JPanel userProcessJpanel, EcoSystem ecoSystem, PackingAgent packingAgent, User userLogged) {
        initComponents();
        this.userProcessJpanel = userProcessJpanel;
        this.ecoSystem = ecoSystem;
        this.packingAgent = packingAgent;
    ...
    private void populateData() {
        namejTextField.setText(packingAgent.getName());
        phoneNojTextField.setText(packingAgent.getPhoneNo());
        emailjTextField.setText(packingAgent.getEmail());
        addressjTextField.setText(packingAgent.getAddress());
        imagePath = packingAgent.getProfilePic();
        setPhoto(packingAgent.getProfilePic());
    }
    ...
    private void initComponents() {
        ...
        headerjLabel.setText("Update Packing Agent");
        ...
        add(uploadjButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 290, -1, -1));
    ...
    private void updatejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatejButtonActionPerformed
        ...
        if (isDataEnteredValid()) {
            ...
            if (!packingAgent.getEmail().equals(emailjTextField.getText()) && EmailHelper.isEmailAlreadyExisted(ecoSystem, emailjTextField.getText())) {
                JOptionPane.showMessageDialog(this, "Email already Exists in the Ecosystem.");
                return;
            }
            if (!packingAgent.getPhoneNo().equals(phoneNojTextField.getText()) && PhoneNoHelper.isPhoneNoAlreadyExisted(ecoSystem, phoneNojTextField.getText())) {
                JOptionPane.showMessageDialog(this, "PhoneNo already Exists in the Ecosystem.");
                return;
            }

            packingAgent.setName(namejTextField.getText());
            packingAgent.setEmail(emailjTextField.getText());
            packingAgent.setPhoneNo(phoneNojTextField.getText());
            packingAgent.setAddress(addressjTextField.getText());
            packingAgent.setProfilePic(imagePath);
            packingAgent.setLastUpdatedDate(new Date());
            packingAgent.setModifiedBy(userLogged.getUserName());
            JOptionPane.showMessageDialog(this, "Successfully updated Packing Agent");
            logger.log(Level.INFO, "Packing Agent Saved");
        } else {
            JOptionPane.showMessageDialog(this, "Error updating  Packing Agent. Please check DataTypes");
        }
