...
public class CreateDriverJPanel extends javax.swing.JPanel {
    ...
    private static final Logger logger = Logger.getLogger(CreateDriverJPanel.class.getName());
    private String imagePath = Constants.DEFAULT_PROFILE_IMAGE_PATH;

    public CreateDriverJPanel(JPanel userProcessJpanel, EcoSystem ecoSystem, User userLogged) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(picHolderjLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 90, 126, 139));
        ...
        add(uploadjButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 250, -1, -1));
        ...
        headerjLabel.setText("Create Driver");
    ...
    private void savejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savejButtonActionPerformed
        ...
        if (isDataEnteredValid()) {
            ...
            Driver driver = new Driver(name, phoneNo, email, address, StudentRole.Student, imagePath,
                    new Date(), new Date(), userLogged.getName(), userLogged.getName());
            ecoSystem.getDriversDirectory().getDrivers().add(driver);

            JOptionPane.showMessageDialog(this, "Successfully saved new Driver");
            resetUi();
        } else {
            JOptionPane.showMessageDialog(this, "Error saving new Driver. Please check DataTypes");
        }
